    ...
    return {
      ...
      rules: {
        name: [{
          ...
          min: 1,
          max: 20,
          message: '长度在1 到 12个字符',
          trigger: 'blur'
        }],
        remarks: [{
          required: true,
          message: '请填写1-100位的名称',
          trigger: 'blur'
        }, {
          min: 1,
          max: 100,
      ...
      [
        _c(
          ...
          [
            _c(
              "el-form-item",
              { attrs: { label: "签名名称", prop: "name" } },
              [
                _c("el-input", {
                  attrs: { placeholder: "请输入中英文或数字" },
                  model: {
                    value: _vm.form.name,
                    callback: function($$v) {
                      _vm.$set(
                ...
                _c(
                  ...
                  [_vm._v("所有发送的短信都会有敏感词检测，请正规使用。")]
                )
              ],
              1
            ),
            _vm._v(" "),
            _c("el-form-item", { attrs: { label: "备注", prop: "remarks" } }, [
              _c(
                "div",
