...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/usercenter/task/taskGroupEdit.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $a54eba = exports.default || module.exports;
      
      if (typeof $a54eba === 'function') {
        $a54eba = $a54eba.options;
      }
    
        /* template */
        Object.assign($a54eba, (function () {
          var render = function() {
  var _vm = this
      ...
      [
        _c(
          ...
          [
            ...
            _c(
              "el-form-item",
              { attrs: { label: "告警联系人", prop: "notice_phone" } },
              [
                _c("el-input", {
                  attrs: { placeholder: "英文逗号隔开的手机号" },
                  model: {
                    value: _vm.form.notice_phone,
                    callback: function($$v) {
                      _vm.$set(_vm.form, "notice_phone", $$v)
                    },
                    expression: "form.notice_phone"
                  }
                })
              ],
              1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a54eba', $a54eba);
          } else {
            api.reload('$a54eba', $a54eba);
          }
        }
...
//# sourceMappingURL=/taskGroupEdit.1f347697.js.map