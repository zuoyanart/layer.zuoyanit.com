...
},{"./url":"../../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../../node_modules/socket.io-parser/index.js","./manager":"../../node_modules/socket.io-client/lib/manager.js","debug":"../../node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"../../node_modules/socket.io-client/lib/socket.js"}],"pages/chart.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    this.ioSocket = (0, _socket.default)(this.$siteConfig.domain + '?appkey=5cdad8fab007211b603c705c&group=test&user=' + this.user);
    this.ioSocket.on('pull', function (data) {
      console.log(data);

      _this.contents.push(data); // document.getElementById('end').scrollIntoView();
...
exports.default = _default;
        var $09057c = exports.default || module.exports;
      
      if (typeof $09057c === 'function') {
        $09057c = $09057c.options;
      }
    
        /* template */
        Object.assign($09057c, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c(
        ...
        _vm._l(_vm.contents, function(item) {
          return _c(
            ...
            [
              item.event == "joined"
                ? _c("p", { staticClass: "joined" }, [
                    _vm._v("用户 user_" + _vm._s(item.msg.from) + "加入群聊")
                  ])
                : item.event == "closed"
                ? _c("p", { staticClass: "joined" }, [
                    _vm._v("用户 user_" + _vm._s(item.msg.from) + "离开了群聊")
                  ])
                : [
                    item.from == _vm.user
                      ? _c("div", { staticClass: "msg right" }, [
                          _c("p", { staticClass: "p1" }, [
                            _vm._v("user_" + _vm._s(item.from))
                          ]),
                          _vm._v(" "),
                          _c("p", { staticClass: "p2" }, [
      ...
      _vm._v(" "),
      _c("div", { staticStyle: { height: "0px" }, attrs: { id: "end" } }),
      _vm._v(" "),
      _c("el-input", {
        staticClass: "send",
        attrs: { placeholder: "请输入聊天内容，回车提交" },
        nativeOn: {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$09057c', $09057c);
          } else {
            api.reload('$09057c', $09057c);
          }
        }
...
},{"socket.io-client":"../../node_modules/socket.io-client/lib/index.js","_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/chart.85c10200.js.map