...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/login.vue":[function(require,module,exports) {
"use strict";
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            ...
                            _context2.next = 4;
                            return _this.$tools.httpAgent('/login', 'post', _this.form, {
                              login: false
                            });
...
exports.default = _default;
        var $678e3f = exports.default || module.exports;
      
      if (typeof $678e3f === 'function') {
        $678e3f = $678e3f.options;
      }
    
        /* template */
        Object.assign($678e3f, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$678e3f', $678e3f);
          } else {
            api.reload('$678e3f', $678e3f);
          }
        }
...
//# sourceMappingURL=/login.c73e2b09.js.map